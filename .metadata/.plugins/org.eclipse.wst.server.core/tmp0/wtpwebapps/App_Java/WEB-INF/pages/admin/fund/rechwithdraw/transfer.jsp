...
<div class="bjui-pageContent">
 	<form action="updateWithdrawTransfer.do" id="j_custom_form" data-toggle="validate" data-alertmsg="false">
        <input type="hidden" name="id" value="${id }">
        <input type="hidden" name="userId" value="${userId }">
        <input type="hidden" name="tabid" value="${tabid }">
        <input type="hidden" name="trxId" value="${item.trxId }">
        <input type="hidden" name="usrCustId" value="${item.usrCustId }">
        <input type="hidden" name="billcode" value="${item.billcode }">
		<table class="table table-condensed table-hover">
		    <tbody>
		        ...
		        <tr>
		         ...
		         <tr>
		        	<td align="center">
		                <label for="j_custom_birthday" class="control-label x100">转账状态：</label>
		                &nbsp;&nbsp;&nbsp;&nbsp;
		                <input type="radio" name="status" id="j_form_radio1" value="2" data-toggle="icheck" data-label="转账成功">
		                &nbsp;&nbsp;&nbsp;&nbsp;
		                <input type="radio" name="status" id="j_form_radio1" value="5" data-toggle="icheck" checked data-label="转账失败">
		            </td>
		            <td></td>
		        </tr>
