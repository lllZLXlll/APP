...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${basePath }admin/borrowFullScale.do?tabid=${tabid}" method="post">
...
<div class="bjui-pageFooter">
    <div class="pages">
        ...
        <span>&nbsp;条，共 ${pageBean.totalNum } 条， 共 ${pageBean.totalPageNum } 页    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前页的满标借款金额合计:	￥${fistAuditAmount} &nbsp;&nbsp;&nbsp;&nbsp;满标借款总金额合计:	￥${borrowTotalAuditAmount}</span>
    </div>
