...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${basePath }admin/borrowAll.do?tabid=${tabid}" method="post">
        ...
        <div class="bjui-searchBar">
        	<br/>
            &nbsp;&nbsp;
            <label>用户名：</label><input type="text" value="${userName}" name="userName" class="form-control" maxlength="30" size="20">&nbsp;
            <label>标的类型:</label>
                ...
                <td>
	                <c:choose>
	               		<c:when test="${borrow.recommend ==0 }">
	               		   <a href="isRecommendBorrow.do?borrowId=${borrow.id}&recommend=1" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定推荐标的吗？">未推荐</a>
						</c:when>
						<c:otherwise>
	               		   <a href="isRecommendBorrow.do?borrowId=${borrow.id}&recommend=0" class="btn btn-green" data-toggle="doajax" data-confirm-msg="确定取消推荐吗？">已推荐</a>
						</c:otherwise>
					</c:choose>
                </td>
                <td>
