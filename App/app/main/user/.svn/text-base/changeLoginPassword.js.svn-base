...
export default class ChangeLoginPassword extends Component{
    constructor(props) {
        super(props);
        this.state = {
            show: false,
    ...
    onPressConfirm=() =>{
        ...
        Request.post('changeLoginPassword.do',params,(data)=>{
            ...
            if (data == 1) {
                ...
                this.props.navigator.push({component:successPage,name:'successPage',params:{
                    retNum:1,
                    successText:'修改登录密码成功',
                }});
            }
        },(error)=>{
            console.log(error);
    ...
    render(){
        return (
            <View style={[styles.flex, styles.body]}>
                <NavigationBar title="重置登录密码" leftShowIcon={true} leftBtnFunc={this._goBack.bind(this)}  />
