...
export default class CheckBox extends Component{
    ...
    onClick () {
        ...
        this.props.onClick(!this.state.isCheck, this.props.text, this.props.index, this.props.i);
    };
    ...
    render(){
        ...
        let imgSource = this.state.isCheck ? require('../images/other/icon_check_checked.png') : require('../images/other/icon_check.png');
