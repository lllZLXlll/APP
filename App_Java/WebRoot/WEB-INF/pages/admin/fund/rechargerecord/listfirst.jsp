...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="queryRechargeFirstInit.do" method="post">
        ...
        <div class="bjui-searchBar">
        	<br/>
            &nbsp;&nbsp;
            <a data-toggle="navtab" href="queryRechargeRecordInit.do?tabid=${tabid}" data-id="changepwd_page" data-mask="true" data-width="500" data-height="500" class="btn btn-blue">&nbsp;充值记录</a>&nbsp;&nbsp;
        	<br /><br />
	       	&nbsp;&nbsp;
        ...
        <tbody>
        	...
        	<c:forEach items="${pageBean.page }" var="beans" varStatus="status">
				<tr data-id="65" align="center">
	                ...
	                <td>汇付充值</td>
	                <td>${beans.rechargeMoney }</td>
	                <td>${beans.cost }</td>
	                <td>${beans.realMoney }</td>
	                <td>${beans.first_recharge }</td>
	                <td>
