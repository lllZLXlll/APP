...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${basePath }admin/borrowFlowMark.do" method="post">
...
<div class="bjui-pageFooter">
    <div class="pages">
        ...
        <span>&nbsp;条，共 ${pageBean.totalNum } 条， 共 ${pageBean.totalPageNum } 页    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前页的流标借款金额合计:	￥${flowmarkAmount} &nbsp;&nbsp;&nbsp;&nbsp; 流标借款金额合计:￥
        	        <c:choose>
	               		<c:when test="${repaymentMap.flowmarkBorrowAmount ==''}">
							 0
						</c:when>
						<c:otherwise>
							${repaymentMap.flowmarkBorrowAmount}
						</c:otherwise>
					</c:choose></span>
