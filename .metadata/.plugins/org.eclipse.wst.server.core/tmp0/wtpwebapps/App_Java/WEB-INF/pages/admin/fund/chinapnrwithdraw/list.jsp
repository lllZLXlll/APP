...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="cashReconciliationIndex.do" method="post">
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        <thead>
            <tr align="center">
                ...
                <th align="center">取现银行卡号</th>
                <th align="center">交易金额（元）</th>
                <th align="center">汇付交易状态</th>
                <th align="center">取现手续费</th>
                <th align="center">手续费支付方</th>
        ...
        <tbody>
        	...
        	<c:forEach items="${pageBean.page }" var="bean" varStatus="status">
				<tr data-id="65" align="center">
					...
					<td>
						<c:if test="${bean.FeeObj=='U' }">用户</c:if>
						<c:if test="${bean.FeeObj=='M' }">商户</c:if>
						<c:if test="${bean.FeeObj=='' }">未知</c:if>
					</td>
					<td>
						${bean.PnrDate}
					</td>
