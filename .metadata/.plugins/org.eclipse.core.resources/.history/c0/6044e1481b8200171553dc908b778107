...
public class IConstants {
	 ...
	 * 注册手机重复
	 */
	public static final String USER_REGISTER_REPEAT_PHONE = "6";
	...
	public static String ISDEMOCODE="";
	...
	static{
		MAIL_HOST = PropertiesUtil.getProper("mail_host");
		MAIL_USERNAME = PropertiesUtil.getProper("mail_username");
		MAIL_PASSWORD = PropertiesUtil.getProper("mail_password");
		MAIL_FROM = PropertiesUtil.getProper("mail_from");
		MAIL_PORT = Integer.parseInt(PropertiesUtil.getProper("mail_port"));			
		ISDEMO = PropertiesUtil.getProper("isDemo");
		ISDEMOCODE = PropertiesUtil.getProper("isDemoCode");
		FONTURL = PropertiesUtil.getProper("fontUrl");
		WEB_APP_VERSION = PropertiesUtil.getProper("web_app_version");
		WEB_APP_URL = PropertiesUtil.getProper("web_app_url");
		BBS_URL = PropertiesUtil.getProper("bbs_url");
		PWD_SES_KEY = PropertiesUtil.getProper("pwd_ses_key");
		BBS_SES_KEY = PropertiesUtil.getProper("bbs_ses_key");
		BBS_KEY = PropertiesUtil.getProper("bbs_key");
		WEB_URL = PropertiesUtil.getProper("web_url");
		ZCM = PropertiesUtil.getProper("com.shove.security.License.SerialNumber");
		APP_URL = PropertiesUtil.getProper("app_url");
		ENABLED_PASS =PropertiesUtil.getProper("enabled_pass");
		PASS_KEY = PropertiesUtil.getProper("pass_key");
		PRO_GLOBLE_NAME = PropertiesUtil.getProper("pro_globle_name");
		NICK = PropertiesUtil.getProper("pro_globle_name");
		OPERATOR_ONLINE = PropertiesUtil.getProper("pro_globle_name");
		sesPWd=PropertiesUtil.getProper("com.shove.security.sesPWd");
		sesKey = PropertiesUtil.getProper("app_see_key");
		ses_key = PropertiesUtil.getProper("ses_key");
		LICENSE = PropertiesUtil.getProper("com.shove.security.License");
	}
	 ...
	 * @since 1.0.0   
	 */
	public static final String ACTOIN_MSG = "投标时间未到";
...
//	public static final int BANK_CHANGE = 4;
	...
	public static final Long PAGE_SIZE_6_LONG = 6L;
	
	public static String URL = "https://www.pujinziben.com/";//http://120.76.203.19:8090/shzc_test/
