...
<!--                     </td> -->
                     ...
                     <td>
                       ...
                       <td>
                        <select name="paymentMode" id="paymentMode" data-toggle="selectpicker" data-rule="required" >
						    <option value="">--请选择--</option>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                       ...
                       <input type="text" name="bidTimeStr" id="bidTime"  data-toggle="datepicker"
                 ...
                 <tr>
                    <td>
                        <label for="j_custom_name" class="control-label x90">借款人介绍：</label>
                        </td>
                       <td colspan="3">
                       <textarea name="projectIntro" id="projectIntro"  data-toggle="kindeditor" data-rule="required" cols="40" rows="8"></textarea>
                    </td>
                </tr>
                 ...
                 <tr>
                     <td>
                       ...
                       <td colspan="3">
                       <textarea name="safeMeasures" id="safeMeasures"  data-toggle="kindeditor" data-rule="required" cols="40" rows="8"></textarea>
                    </td>
