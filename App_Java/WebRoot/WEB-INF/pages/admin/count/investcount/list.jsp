...
<div class="bjui-pageContent tableContent" > 
    ...
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tbody>
			...
			<tr data-id="65" align="center">
				...
				<td align="center">
                	<fmt:formatNumber value="${invest.borrowManageFee }" type="currency" pattern="#,##0.00"/>
				</td>
			</tr>
			<tr data-id="65" align="center">
				<td>
    ...
    <br/>
    <div class="col-md-6">
        <div class="panel panel-default" style="width:1200px;height:500px;margin-left:10%;">
            <div class="panel-heading"><h3 class="panel-title" style="margin-left:48%;">图表展示 </h3></div>
            <div class="panel-body">
                <div style="mini-width:1000px;height:450px" data-toggle="echarts" data-type="pie,funnel" data-url="queryStatisEcharts.do?radio=${radio}&timeStart=${beginTime}&timeEnd=${endTime}"></div>
            </div>
        </div>
    </div>
</div>
