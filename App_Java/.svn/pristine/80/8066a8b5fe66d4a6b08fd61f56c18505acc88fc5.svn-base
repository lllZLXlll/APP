            ...
            <tbody>
				...
				<c:choose>
               		<c:when test="${borrowMTenderInDetail.borrowShow==1}">
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">项目描述：</label>${borrowMTenderInDetail.detail}
		                    </td>
		                </tr>
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">项目介绍：</label>${borrowMTenderInDetail.projectIntro}
		                    </td>
		                </tr>
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">还款来源：</label>${borrowMTenderInDetail.projectIntro}
		                    </td>
		                </tr>
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">保障措施：</label>${borrowMTenderInDetail.safeMeasures}
		                    </td>
		                </tr>
					</c:when>
					<c:when test="${borrowMTenderInDetail.borrowShow==2}">
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">借款方商业概述：</label>${borrowMTenderInDetail.businessDetail}
		                    </td>
		                </tr>
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">借款方资产情况：</label>${borrowMTenderInDetail.assets}
		                    </td>
		                </tr>
		                <tr height="30px">
		                    <td colspan="2" >
		                    	<label for="j_custom_name" class="control-label">借款方资金用途：</label>${borrowMTenderInDetail.moneyPurposes}
		                    </td>
		                </tr>
					</c:when>
				</c:choose>
