            ...
            <tbody>
                ...
                <tr>
                    <td style="border: none;">
                        ...
                        <input type="text" name="link" id="j_custom_name" width="400px"  size="20" value="${banner.link}">
                    </td>
                </tr>
                <tr>
                    <td style="border: none;">
                        <label for="j_custom_birthday" class="control-label x85">是否显示：</label>
                        <select id="j_custom_name" name="isShow" data-toggle="selectpicker">
							<option value="1" ${banner.isShow == 1 ? 'selected' : '' }>是</option>
							<option value="2" ${banner.isShow == 2 ? 'selected' : '' }>否</option>
						</select>
                    </td>
                </tr>
            </tbody>
