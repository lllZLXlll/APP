<%-- <%@page import="com.pjzb.entity.Admin"%> --%>
...
<title>管理首页</title>
<!-- <link rel="icon" href="../images/logo_title.jpg" type="image/x-icon" /> -->
<meta name="Keywords"
...
<!-- bootstrap - css -->
<link href="../resources/admin/bjui/BJUI/themes/css/bootstrap.css"
	rel="stylesheet">
<!-- core - css -->
<link href="../resources/admin/bjui/BJUI/themes/css/style.css"
	rel="stylesheet">
<link href="../resources/admin/bjui/BJUI/themes/blue/core.css"
	id="bjui-link-theme" rel="stylesheet">
<!-- plug - css -->
<link
	href="../resources/admin/bjui/BJUI/plugins/kindeditor_4.1.10/themes/default/default.css"
	rel="stylesheet">
<link
	href="../resources/admin/bjui/BJUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css"
	rel="stylesheet">
<link
	href="../resources/admin/bjui/BJUI/plugins/niceValidator/jquery.validator.css"
	rel="stylesheet">
<link
	href="../resources/admin/bjui/BJUI/plugins/bootstrapSelect/bootstrap-select.css"
	rel="stylesheet">
<link
	href="../resources/admin/bjui/BJUI/themes/css/FA/css/font-awesome.min.css"
	rel="stylesheet">
<!--[if lte IE 7]>
...
<![endif]-->
<!-- BJUI.all 分模块压缩版 -->
<script src="../resources/admin/bjui/BJUI/js/bjui-all.js"></script>
...
<script
	src="../resources/admin/bjui/BJUI/plugins/swfupload/swfupload.js"></script>
<!-- kindeditor -->
<script
	src="../resources/admin/bjui/BJUI/plugins/kindeditor_4.1.10/kindeditor-all.min.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/kindeditor_4.1.10/lang/zh_CN.js"></script>
<!-- colorpicker -->
<script
	src="../resources/admin/bjui/BJUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- ztree -->
<script
	src="../resources/admin/bjui/BJUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
<!-- nice validate -->
<script
	src="../resources/admin/bjui/BJUI/plugins/niceValidator/jquery.validator.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/niceValidator/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
<script src="../resources/admin/bjui/BJUI/plugins/bootstrap.min.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
<!-- icheck -->
<script src="../resources/admin/bjui/BJUI/plugins/icheck/icheck.min.js"></script>
<!-- dragsort -->
<script
	src="../resources/admin/bjui/BJUI/plugins/dragsort/jquery.dragsort-0.5.1.min.js"></script>
<!-- HighCharts -->
<script
	src="../resources/admin/bjui/BJUI/plugins/highcharts/highcharts.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/highcharts/highcharts-3d.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/highcharts/themes/gray.js"></script>
<!-- ECharts -->
<script src="../resources/admin/bjui/BJUI/plugins/echarts/echarts.js"></script>
<!-- other plugins -->
<script
	src="../resources/admin/bjui/BJUI/plugins/other/jquery.autosize.js"></script>
<link
	href="../resources/admin/bjui/BJUI/plugins/uploadify/css/uploadify.css"
	rel="stylesheet">
<script
	src="../resources/admin/bjui/BJUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/download/jquery.fileDownload.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/echarts/chart/pie.js"></script>
<script
	src="../resources/admin/bjui/BJUI/plugins/echarts/chart/funnel.js"></script>
<!-- init -->
...
$(function() {
    BJUI.init({
        ...
        ajaxTimeout  : -1, //[可选]全局Ajax请求超时时间(毫秒)
...
<!-- <link type="text/css" rel="stylesheet"
	href="/js/syntaxhighlighter-2.1.382/styles/shCore.css" />
<link type="text/css" rel="stylesheet"
	href="/js/syntaxhighlighter-2.1.382/styles/shThemeEclipse.css" />
<script type="text/javascript"
	src="/js/syntaxhighlighter-2.1.382/scripts/brush.js"></script> -->
<link href="../resources/admin/bjui/doc/doc.css" rel="stylesheet">
<script type="text/javascript">
$(function(){
	$.ajax({
        type: "post",
        ...
        success: function (data) {
          ...
          var s="";
		   ...
		   var id = json[index].id;
            var key = json[index].summary;
            var id = json[index].id;
            var son = json[index].son;
		   	var ulHtml="<li id='myli"+id+"'><a href='javascript:;' data-toggle='slidebar'>"+key+"</a> <div id='myform"+id+"' class='items hide' data-noinit='true'><ul id='bjui-hnav-tree"+id+"' class='ztree ztree_main' data-toggle='ztree' data-on-click='MainMenuClick' data-expand-all='true' data-faicon='check-square-o'>";
            for(var i=0; i<son.length; i++){ 
            	var number=id+30+i+1; 
     			var name=son[i].summary;
     			var action=son[i].action;
     			var sonId=son[i].id;
     			li+="<li data-id='"+number+"' data-pid='"+id+"' data-url='"+action+"?tabid=submenu-tab-"+sonId+"' data-tabid='submenu-tab-"+sonId+"' data-faicon='caret-right'>"+name+"</li>";
 			 }  
 			 
      		ulHtml=ulHtml+li+"</ul></div></li>";
      		s+=ulHtml;
       		$("#bjui-hnav-navbar").html(s);
       //		$("#myli-1").addClass("active");
          });
        }
    });
		...
		<header id="bjui-header">
			<div class="bjui-navbar-header">
				...
				<a class="bjui-navbar-logo" href="#"><img
					src="../resources/admin/bjui/images/logo.png"></a>
			</div>
...
<!-- 					<li><a href="#">消息 <span class="badge">4</span></a></li> -->
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="updatePasswordInit.do" data-toggle="dialog"
								data-id="changepwd_page" data-mask="true" data-width="500"
								data-height="300">&nbsp;<span
									class="glyphicon glyphicon-lock"></span> 修改密码&nbsp;
							</a></li>
							<li><a href="#">&nbsp;<span
									class="glyphicon glyphicon-user"></span> 我的资料
							</a></li>
							<li class="divider"></li>
							<li><a href="logout.do" class="red">&nbsp;<span
