...
<div class="bjui-pageHeader">
    ...
    <form id="pagerForm" data-toggle="ajaxsearch" action="queryRecordInit.do?operation_around=${operation_around2}" method="post">
    	<div class="bjui-searchBar">
	        <input type="hidden" name="tabid" value="${tabid}">
	        <input type="hidden" name="pageSize" value="${pageSize}">
	        <input type="hidden" name="pageCurrent" value="${model.pageCurrent}">
	       	<br/>&nbsp;&nbsp;
	       	<label>用户名：</label><input type="text" id="userName1" value="${userName }" name="userName" class="form-control">&nbsp;
	        
			<label>操作时间：</label>
	        <input type="text" value="${startTime }" size="16" name="startTime" id="startTime1" readonly="readonly" data-toggle="datepicker" placeholder="开始日期">
	        <label>—</label>
	        <input type="text" value="${endTime }" size="16" name="endTime" id="endTime1" readonly="readonly" data-toggle="datepicker" placeholder="结束日期">&nbsp;
           	<button type="button" onclick="submitBtn1()" class="btn-default" data-icon="search">查询</button>&nbsp;
